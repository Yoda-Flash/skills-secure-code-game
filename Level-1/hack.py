...
class TestOnlineStore(unittest.TestCase):
    ...
    def test_4(self):
        ...
        self.assertEqual(c.validorder(order_4), 'Payment amount exceeded, please reduce your payment amount.')
    ...
    def test_5(self):
        ...
        self.assertEqual(c.validorder(order_5), 'Total amount exceeded, please reduce your total amount.')
